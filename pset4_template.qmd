...
merged_df = (
    active_hospitals_2016.merge(
        dataframes[1][["PRVDR_NUM", "PGM_TRMNTN_CD"]].rename(
            columns={"PGM_TRMNTN_CD": "PGM_TRMNTN_CD_2017"}
        ),
        on="PRVDR_NUM",
        how="left",
    )
    .merge(
        dataframes[2][["PRVDR_NUM", "PGM_TRMNTN_CD"]].rename(
    ...
    .merge(
        dataframes[3][["PRVDR_NUM", "PGM_TRMNTN_CD"]].rename(
