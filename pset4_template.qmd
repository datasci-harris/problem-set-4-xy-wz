...
1. 
    ...
    directory_path = '/Users/cynthia/Desktop/gz_2010_us_860_00_500k'
...
base_path = "/Users/cynthia/Desktop"

pathshp = os.path.join(base_path, "gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.shp")
...
hospital_2016 = pos2016[(pos2016['PRVDR_CTGRY_CD'] == 1) & (pos2016['PRVDR_CTGRY_SBTYP_CD'] == 1)]

hospital_2016['ZIP_CD'] = hospital_2016['ZIP_CD'].astype(str).str.replace(r'\.0$', '', regex=True).str.zfill(5)
...
map_texas.plot(column='hospital_count', cmap='viridis', linewidth=0.8, ax=ax, edgecolor='0.8', legend=True)
